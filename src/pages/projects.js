      ...
      <CardGroup>
       <Row className="cardRow">
          <Col sm={{ size: 12}} md={{ size: 4 }}>
            <a href="https://waimeavalley.net/"> <CardImg  className="cardImage" href="https://waimeavalley.net" top width="100%" src="https://res.cloudinary.com/drgess24j/image/upload/v1554110962/waimeavalley-min.png" alt="waimeaValleysite" /> </a>
          </Col>
